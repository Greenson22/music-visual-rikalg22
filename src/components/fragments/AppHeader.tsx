// src/components/fragments/AppHeader.tsx
import React from 'react';
import GlassPanel from '../elements/GlassPanel';
import IconButton from '../elements/IconButton';
import { FaClosedCaptioning, FaMicrophone, FaExpand, FaWaveSquare, FaFolderOpen } from 'react-icons/fa6';

interface Props {
  statusText: string;
  onOpenModal: () => void;
  onMicMode: () => void;
  onOpenLibrary?: () => void; // Optional, hanya muncul jika folder sudah diload
}
