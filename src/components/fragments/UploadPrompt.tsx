// src/components/fragments/UploadPrompt.tsx
...
interface Props {
  ...
  onFolderUpload: (e: ChangeEvent<HTMLInputElement>) => void;
}

export default function UploadPrompt({ onFileUpload, onFolderUpload }: Props) {
  return (
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center pointer-events-auto transition-opacity duration-500 w-full max-w-2xl px-4">
      ...
      <div className="flex flex-col md:flex-row gap-6 justify-center">
        ...
        <label className="cursor-pointer group flex-1">
          ...
          {/* Atribut 'webkitdirectory' dan 'directory' memungkinkan pemilihan folder */}
          <input 
            type="file" 
